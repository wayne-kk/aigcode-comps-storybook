...
const PricingComponent: React.FC<PricingComponentProps> = ({
  ...
  return (
    <Card className=" w-full h-full max-w-[533px] bg-white rounded-xl border border-solid border-gray-200 shadow-none p-0">
      ...
      <CardContent className="flex flex-col justify-between p-6 pb-12 h-full">
