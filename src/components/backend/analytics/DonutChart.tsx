...
function PricingComponent({
  ...
  const chartData = [
    { name: 'completed', value: completionPercentage, fill: '#3b82f6' },
    { name: 'remaining', value: 100 - completionPercentage, fill: '#e5e7eb' },
  ];

  return (
    <div className="w-full max-w-[534px] mx-auto rounded-xl border border-gray-200 shadow-sm overflow-hidden bg-white h-full flex flex-col">
      <Card className="flex flex-col h-full shadow-none border-0 flex-1">
