...
function PricingComponent({
  ...
  return (
    <div className="w-full max-w-[534px] h-full flex flex-col">
      <Card className="bg-white shadow-sm rounded-xl border border-gray-100 min-h-[228px] h-full flex flex-col">
        ...
        <CardContent className="px-6 pt-8 pb-6 flex-1 flex flex-col justify-center">
          <div className="grid grid-cols-2 gap-4 divide-x divide-gray-200 mb-5">
            <div className="flex items-center gap-3 text-sm">
              <Badge className="bg-blue-100 text-blue-700 rounded-md px-2 py-0.5 font-medium text-xs border-0">
                {orderPercentage}
              </Badge>
              <span className="text-gray-700">{orderLabel}</span>
            </div>
            <div className="flex items-center justify-end gap-3 text-sm pl-4">
              <Badge className="bg-purple-100 text-purple-700 rounded-md px-2 py-0.5 font-medium text-xs border-0">
                {visitPercentage}
              </Badge>
          ...
          <div className="flex h-4 overflow-hidden rounded-md">
            <span className="bg-blue-500 h-full" style={{ width: `${orderBarPercentage}%` }}></span>
            <span className="bg-purple-500 h-full" style={{ width: `${visitBarPercentage}%` }}></span>
          </div>
        </CardContent>
      </Card>
    </div>
