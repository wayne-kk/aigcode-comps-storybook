...
const Hero_31_01: React.FC<IHeroProps> = ({
  titleWords = {
        ...
        <div className="w-full h-full grid grid-cols-1 gap-16 md:grid-cols-2">
          ...
          >
            ...
            <div className="w-full aspect-[4/3] relative">
              ...
              <EditableImg
                propKey={`image_src`}
                className="IMAGE absolute inset-0 w-[544px] min-w-[544px] !h-[408px] bg-zinc-200 dark:bg-zinc-800 !object-cover"
                src={image.src}
                alt={`image_src`}
